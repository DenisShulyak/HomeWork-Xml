...
namespace HomeWorkXML
{
    class Program
    {
        ...
        private static void Task2()
        {
            ...
            student.SetAttribute("FirstName", "Александр");
            student.SetAttribute("LastName", "Васильев");
            student.SetAttribute("Gender", "Male");
            students.AppendChild(student);
            Console.WriteLine(xmlDocument.DocumentElement.FirstChild.Attributes["FirstName"].Value + " " + xmlDocument.DocumentElement.FirstChild.Attributes["LastName"].Value + " " + xmlDocument.DocumentElement.FirstChild.Attributes["Gender"].Value);
            Console.ReadLine();
        }
    }
}
